  ...
  return (
    <div className="w-full mx-auto px-4 md:px-6">
      <div className="flex flex-col items-center text-center py-6">
        <h2 className="text-4xl font-light leading-tight tracking-wide">Beautiful Spaces.</h2>
        <h2 className="text-4xl font-light leading-tight tracking-wide">Functional Excellence.</h2>
        <div className="my-4">
          <h2 className="text-4xl font-light leading-tight tracking-wide text-module-design">designOS</h2>
        </div>
