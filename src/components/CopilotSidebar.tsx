...
import { X, Mic, Send, Bot, Zap, Brain, Sparkles, ArrowRight } from 'lucide-react';
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed top-0 right-0 h-screen z-50 w-full sm:w-96 bg-background border-l border-border shadow-xl flex flex-col"
        >
          {/* Header */}
